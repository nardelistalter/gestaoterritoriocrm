...
@section('titulo', 'Grupos de Produtos')
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <h1 id="page-title" class="h3 mb-0 text-gray-800 font-weight-bold">{{ __('Cadastro de Grupos de Produtos') }}</h1>
        </div>

        <!-- Content Datatable -->
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">{{ __('Grupos de Produtos') }}</h6>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="datatableGrupoProduto" class="table table-bordered table-sm table-responsive text-center datatable"
                        cellspacing="0" width="100%">
                        <thead class="thead-dark">
                            <tr class="text-justify">
                                <th class="th-sm">id</th>
                                <th class="th-sm">Descrição</th>
                                <th class="th-sm">Unidade de Medida</th>
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header bg-success">
                    <h5 class="modal-title text-white font-weight-bold" id="addModalLabel">{{ __('Novo Grupo de Produto') }}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{ action('App\Http\Controllers\GrupoProdutoController@store') }}" method="POST">
                    {{ csrf_field() }}
                    <div class="modal-body">

                        <div class="form-group">
                            <label for="add-grupoproduto">Descrição</label>
                            <input type="text" class="form-control" maxlength="45" id="add-grupoproduto" name="add-grupoproduto">
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header bg-warning">
                    <h5 class="modal-title text-dark font-weight-bold" id="editModalTitle">{{ __('Alterar Grupo de Produto') }}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="/grupoproduto" method="POST" id="editForm">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="up-grupoproduto">Descrição</label>
                            <input type="text" class="form-control" maxlength="45" id="up-grupoproduto" name="up-grupoproduto" required>
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header bg-info">
                    <h5 class="modal-title text-white font-weight-bold" id="viewModalTitle">{{ __('Ver Grupo de Produto') }}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="" method="POST" id="viewForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" maxlength="45" id="v-grupoproduto" name="v-grupoproduto" readonly>
                        </div>
                        <div class="form-group col-xs-2">
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header bg-danger">
                    <h5 class="modal-title text-white font-weight-bold" id="deleteModalTitle">{{ __('Excluir Grupo de Produto') }}</h5>
                    <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="/grupoproduto" method="POST" id="deleteForm">
                    {{ csrf_field() }}
                    {{ method_field('DELETE') }}
                    <div class="modal-body">
...
@section('script_pages')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var table = $('#datatableGrupoProduto').DataTable();
            ...
            table.on('click', '.edit', function() {
                ...
                $('#up-grupoproduto').val(data[1]);
                $('#up-unidadeMedida').val(data[2]);

                $('#editForm').attr('action', '/grupoproduto/' + data[0]);
            ...
            table.on('click', '.delete', function() {
                ...
                $('#deleteForm').attr('action', '/grupoproduto/' + data[0]);
